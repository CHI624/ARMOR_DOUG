...
# Try to import shared path configuration to locate stop words consistently.
try:
...
# Resolve stop-words location: env override -> configured demo stop_words -> local default.
stop_words_file = (
